    ...
    fun ready(addressFrom: SuggestionsAddress, addressTo: SuggestionsAddress){
        ...
        GlobalScope.launch(handler) {
            val fromTask = async {
                ...
                return@async apiService.getCoordinateByHereLocation(GetCoordinateRequestModel(addressFrom.hereLocationId))
                    .execute()
                    .body()
            }
            val toTask = async {
                ...
                return@async apiService.getCoordinateByHereLocation(GetCoordinateRequestModel(addressTo.hereLocationId))
                    .execute()
                    .body()
            }
